    ...
    <div className='md:flex items-center px-3 md:px-0 mt-2 md:mt-10 gap-x-10 mb-16'>
        ...
        <div className='text-center'>
            ...
            <h2 className='text-black dark:text-neutral-200 font-semibold text-lg pt-1 pb-2'>
              Analista de sistemas y frontend developer de <span className='text-blue-400'>Argentina</span>.</h2>
            <div className='md:flex'>
              <button className="text-black font-semibold px-4 py-2 bg-yellow-400/90 hover:bg-yellow-300 rounded-md" 
              onClick={downloadPDF}>
                Descargar CV
              </button>
            </div>
